...
import nehe.demos.common.ResourceRetriever;
import nehe.demos.common.TextureReader;
import nehe.demos.nehe.lesson30.math.Tuple3d;
...
class Renderer implements GLEventListener {
	...
	public void init(GLAutoDrawable drawable) {
		...
		try {
			audioSample = new AudioSample(ResourceRetriever
	...
	private void loadGLTextures(GL gl) {
		 ...
		 * the data itself.
		 */
		gl.glTexImage2D(GL.GL_TEXTURE_2D, 0, 3, image1.getWidth(), image1
				.getHeight(), 0, GL.GL_RGB, GL.GL_UNSIGNED_BYTE, image1
				.getPixels());
		 ...
		 * the data itself.
		 */
		gl.glTexImage2D(GL.GL_TEXTURE_2D, 0, 3, image2.getWidth(), image2
				.getHeight(), 0, GL.GL_RGB, GL.GL_UNSIGNED_BYTE, image2
				.getPixels());
		 ...
		 * the data itself.
		 */
		gl.glTexImage2D(GL.GL_TEXTURE_2D, 0, 3, image3.getWidth(), image3
				.getHeight(), 0, GL.GL_RGB, GL.GL_UNSIGNED_BYTE, image3
				.getPixels());
		 ...
		 * the data itself.
		 */
		gl.glTexImage2D(GL.GL_TEXTURE_2D, 0, 3, image4.getWidth(), image4
				.getHeight(), 0, GL.GL_RGB, GL.GL_UNSIGNED_BYTE, image4
				.getPixels());
	}
