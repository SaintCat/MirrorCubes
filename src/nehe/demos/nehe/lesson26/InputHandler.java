...
class InputHandler extends KeyAdapter {
    ...
    public InputHandler(Renderer renderer, GLDisplay glDisplay) {
        ...
        glDisplay.registerKeyStrokeForHelp(KeyStroke.getKeyStroke(KeyEvent.VK_S, 0), "");
        glDisplay.registerKeyStrokeForHelp(KeyStroke.getKeyStroke(KeyEvent.VK_D, 0), "");
    }
